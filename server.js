...
// let App = require('./src/components/App.js'); // for pre-rendering the app on server you'll need to build a .js next to each .jsx component
...
app.get('/src/*.jsx', function(req, res){ // jsx'fy when necessary
